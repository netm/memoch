...
<p>使い方の説明です。</p>
<p>メモ付き電卓のwebブラウザ無料サイトは、初心者でも簡単に使えます。</p>
<p>まずは「メモ付き電卓」をクリックして下さい。</p><br>

        <h3>電卓</h3>
<p>電卓として、数字「0～9」と「.」で値を入力。</p>
<p>「×　かけ算」, 「÷　わり算」</p>
<br>
        <h3>その他のボタン</h3>
...
<p>「⌫」は、最後の文字を１つ削除します。</p>
<br>
<h2>メモ付き電卓の下段にあるメモ帳</h2>
<p><a href="https://memoc.pages.dev/memod/" target="_blank">メモ付き電卓</a>の下段にあるメモ帳は、文字をメモしておくことができます。</p><br>
<p>「何の計算をしているか」「何日分か」「何名分」「どこまでやったか」</p><br>
<p>などをメモ帳として記録し保存できます。</p>
<p>「AC」は、すべてクリアして、リセットします。</p>
<br>
        <h3>PNG画像保存ボタン</h3>
<p>PNG画像として保存できるボタンです。</p>
<p>下段のメモ帳まで保存できて便利な機能☆</p>
<br>
         <p>便利な電卓・計算機</p>
