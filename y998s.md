...
<p><a href="https://memoc.pages.dev/tver/" target="_blank">TVerティーバーの検索用リンク集</a>　　<a href="https://memoc.pages.dev/tokei/" target="_blank">現在時刻リアルタイム</a>　　<a href="https://memoc.pages.dev/yzpa1/" target="_blank">タイマー</a>　　<a href="https://memoc.pages.dev/yzp1/" target="_blank">勉強タイマー</a></p>
...
<img src="/images/zlondonbus2.png" alt="ロンドンバスのイラスト" width="220" height="200" align="left"><p>書き込みカレンダーのページを作成しました。</p><br><p>無料で、スマホのタッチやパソコンのマウスで手作り感覚で記入できます。</p><br>
<p>☆<a href="https://memoc.pages.dev/y998/" target="_blank">カレンダー今月 無料で書き込みダウンロード保存も</a>☆（スマホ・タブレット・PCパソコン対応）</p><br>
<p>上記をクリックすると「今月のカレンダー」が表示されます。</p>
<p>設定なしでそのまま書き込めて、便利です。</p><br>
          <br clear="left">
<h3>カレンダーに記録</h3>
<p>カレンダーに記録できます。</p>
<p>端末のブラウザに記憶するので、後日カレンダーをひらいても記入した予定は残っています☆</p><br>

<p>「すべて消去」ボタンを押すと、記録は0になります☆</p><br>
<p>書き込んだスマホからなら、翌日でも翌月でも書いた予定が見れます。</p>
<p>他のスマホやパソコンからは見れないのでご安心を☆</p><br>
<p>書き込んだパソコンからなら、後日そのパソコンからのみ「書いた予定」を見れます☆</p>
<p>アプリいらずpdfとワード不要のサイトです☆</p><br>
<h3>年月</h3>
<p>最初は「今月のカレンダー」が表示されています。</p>
<p>年月、の横にある左向きのカッコをクリックすると「先月のカレンダー」です。</p><br>
<p>右向きのカッコをクリックすると「来月のカレンダー」になります☆</p>
<p>さらにクリックすると「再来月のカレンダー」や来年度のカレンダーも☆</p><br>
<h3>PNGダウンロード保存</h3>
<p>「PNGダウンロード保存ボタン」を押すと、画像として保存できます。</p><br>
<p>書き込まなければ、市販のカレンダーの画像になります。</p>
<p>画像をそのままプリントアウトすると、紙のカレンダーに☆</p>
<p>市販のカレンダー買わずに済むので、節約に☆</p><br>
<p>自分用の予定表カレンダーとして書き込んでからでも、画像に変換できます☆</p>
<p>ご家族、お友達や恋人に、送信して予定を共有シェア☆</p><br>
        <h2>手作りできるよう子どもも簡単にできる書き込みカレンダー</h2>
<p>誰でも手作りできるよう、簡単操作にしました。</p>
<p>子どもも簡単に操作できる書き込みカレンダーです☆</p><br>
<h3>ペンの色</h3>
<p>ペンの色も簡単に変更できます。</p>
<p>好きな色をタッチかクリックするだけで、色変換☆</p>
<p>一番右の色をクリックすると、細かい色も指定可能☆</p><br>
<h3>文字の太さ</h3>
<p>文字の太さも簡単に変更できます。</p>
<p>水色のバーを右にずらすと、ペンの文字が太くなります☆</p><br>
<h3>消しゴム機能</h3>
<p>消しゴム機能もあります。</p>
<p>カレンダーに記入した絵や文字を消せます☆</p><br>
<h3>一つ戻すボタン</h3>
<p>「一つ戻すボタン」は、一筆分だけ消せます。</p>
<p>なんて便利なんでしょう!</p><br>
<h3>すべて消去ボタン</h3>
<p>「すべて消去ボタン」は、書いた予定や絵文字を全部消せます。</p>
<p>ついでに、あの頃の失敗も消してくれませんか?(←何があったの)</p><br>
         <br>
        <h2>書き込みカレンダーはPC・スマホ・タブレット対応している無料webサイト</h2>
<p>PCノートパソコン・スマホ・タブレットも対応しています。</p><br>
<p>パソコンの操作は、クリックになります。</p><br>
<p>スマホ・タブレットの操作は、タッチで可能です。</p>
<p>書き込みカレンダーのwebサイトは、アプリ不要、更新ダウンロードなし☆</p>
<br>
<p>無料で使用できます☆</p><p>ブックマークにお気に入り登録して、ご自由にお使い下さい。</p><br>
<p>このページで、スマホの右上の点々をクリックして「ホーム画面に追加」すると、便利です☆</p><br>
<p>☆<a href="https://memoc.pages.dev/y998/" target="_blank">カレンダー今月 無料で書き込みダウンロード保存も</a>☆（スマホ・タブレット・PCパソコン対応）</p><br>
 <p>便利だな、友達に教えたい、と思ったら、<span style="color:#960087;background-color:#FFDDFF;font-size:1.2em;">https://memoc.pages.dev/</span>をコピペして、ご自身のSNSやブログなどに書いていただけると幸いです。</p><br>
<p>便利なタイマー</p>
...
<br>
        ...
        <div id="footer"><p><a href="https://memoc.pages.dev/">メモ帳代わりwebブラウザ便利サイト 無料で生活に役立つリンク集</a>　　<a href="https://memoc.pages.dev/sitemap/">サイトマップ</a></p><p><a href="https://memoc.pages.dev/tver/" target="_blank">TVerティーバーの検索用リンク集 ジャンル タレント名 俳優別</a>　　<a href="https://memoc.pages.dev/y10k2/" target="_blank">英単語勉強法のおぼえやすい方法とおぼえにくい方法</a></p>
