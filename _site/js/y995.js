document.addEventListener('DOMContentLoaded', () => {
    ...
    const genres = [
        '自分で入力', 'ファンタジー', '日常風景', '歴史・時代劇', 'サイエンスフィクション', 'サイバーパンク', 'スチームパンク', '神話・伝説', '夢・夢幻世界', 'ポストアポカリプス', '水中世界', '宇宙・銀河', '未来都市', '古代文明', 'メカ・ロボット', 'モンスター・クリーチャー', '幻獣・ドラゴン', 'ファッションイラスト', 'スポーツ・アクション', '食べ物・スイーツ', '植物・ボタニカル', '建築・ランドマーク', 'ストリートアート・グラフィティ', '抽象表現', 'ポートレイト（人物画）', 'ミニマルデザイン', 'ミニキャラ・デフォルメ', 'ミュージカル・楽器', '四季・風物詩', 'おとぎ話・童話', 'ホラー・ゴシック'
    ];
  ...
  'ホラー・ゴシック': [
    ...
    function displayResult() {
        ...
        resultDisplay.textContent = state.segments[winningIndex] || '無記入';
    }
