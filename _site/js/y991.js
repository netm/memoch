document.addEventListener('DOMContentLoaded', () => {
    const STORAGE_KEY = 'garbageCalendarSettings_page1';
    ...
    const defaultItems = [
        { name: '可燃', abbr: '可燃ごみ', freq: 'weekly', day: 1, color: '#ff0000', weight: 900 },
        { name: '可燃', abbr: '可燃ごみ', freq: 'weekly', day: 4, color: '#ff0000', weight: 900 },
        { name: '不燃', abbr: '不燃ごみ', freq: '1st-3rd', day: 3, color: '#000000', weight: 900 },
        { name: 'プラ', abbr: 'プラスチック', freq: 'weekly', day: 2, color: '#0000ff', weight: 800 },
        { name: '古紙', abbr: '古紙', freq: '2nd-4th', day: 5, color: '#00b012', weight: 800 },
        { name: '段ボ', abbr: '段ボール', freq: '1st-3rd', day: 5, color: '#cca000', weight: 800 },
        { name: 'ペット', abbr: 'ペットボトル', freq: 'weekly', day: 5, color: '#0087b8', weight: 800 },
        { name: 'びん・缶', abbr: 'びん・缶', freq: 'weekly', day: 3, color: '#ffa500', weight: 800 },
        { name: '有害', abbr: '有害ごみ', freq: '2nd-4th', day: 3, color: '#b3007d', weight: 800 },
    ];
